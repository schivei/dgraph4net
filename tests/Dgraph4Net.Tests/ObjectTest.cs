...
public class ObjectTest : ExamplesTest
{
    ...
    class SPerson : IEntity
    {
        ...
        [JsonPropertyName("friend|age"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public double Age { get; set; } // `json:"friends|age,omitempty"`

        [JsonPropertyName("friend|close"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public bool Close { get; set; } = false; // `json:"friends|close,omitempty"`

        [JsonPropertyName("school"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    public async Task TxnMutateFacetsTest()
    {
        ...
        try
        {
            ...
            var serialized = JsonSerializer.Serialize(p, new JsonSerializerOptions { WriteIndented = true });
            ...
            try
            {
                ...
                Json(expected, me, JsonSerializer.Serialize(p, new JsonSerializerOptions { WriteIndented = true }));
            }
            catch
            {
