...
dotnet nuget push ./build-packages/Dgraph4Net.Core.1.0.0.nupkg -k $1 -s https://api.nuget.org/v3/index.json --skip-duplicate
dotnet nuget push ./build-packages/Dgraph4Net.1.0.0.nupkg -k $1 -s https://api.nuget.org/v3/index.json --skip-duplicate
dotnet nuget push ./build-packages/Dgraph4Net.Identity.Core.1.0.0.nupkg -k $1 -s https://api.nuget.org/v3/index.json --skip-duplicate
dotnet nuget push ./build-packages/Dgraph4Net.Identity.1.0.0.nupkg -k $1 -s https://api.nuget.org/v3/index.json --skip-duplicate
