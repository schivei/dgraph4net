...
internal class DatabaseUpdateCommand : Command
{
    private ILogger _logger;

    public DatabaseUpdateCommand(ILogger<DatabaseUpdateCommand> logger,
        ProjectOption project, ServerArgument server, UserIdOption userId,
        PasswordOption password)
        : base("update", "Update the database")
    {
        _logger = logger;
