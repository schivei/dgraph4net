...
public static class TypeExtensions
{
    ...
    public static bool IsGoRegexp(this string pattern)
    {
        try
        {
            ...
            string regexContent = pattern[1..];
            string flags = string.Empty;

            int flagsStart = regexContent.Length;
            for (int i = regexContent.Length - 1; i >= 0; i--)
            {
                char currentChar = regexContent[i];
            ...
            string regexWithoutFlags = regexContent[0..flagsStart];
