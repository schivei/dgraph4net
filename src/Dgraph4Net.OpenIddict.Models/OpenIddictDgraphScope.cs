...
namespace Dgraph4Net.OpenIddict.Models
{
    ...
    public class OpenIddictDgraphScope : AEntity<OpenIddictDgraphScope>
    {
        ...
        /// </summary>
        [JsonProperty("oidc_description"), StringPredicate]
        ...
        /// </summary>
        [JsonProperty("oidc_descriptions"), StringLanguage]
        ...
        /// </summary>
        [JsonProperty("oidc_name"), StringPredicate]
        ...
        /// </summary>
        [JsonProperty("oidc_resources"), StringPredicate]
