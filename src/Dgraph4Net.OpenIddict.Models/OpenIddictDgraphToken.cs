...
public class OpenIddictDgraphToken: AEntity<OpenIddictDgraphToken>
{
    ...
    /// </summary>
    [JsonPropertyName("oidc_app_token"), ReversePredicate, PredicateReferencesTo(typeof(OpenIddictDgraphApplication))]
    ...
    /// </summary>
    [JsonPropertyName("oidc_auth_token"), ReversePredicate, PredicateReferencesTo(typeof(OpenIddictDgraphAuthorization))]
    ...
    /// </summary>
    [JsonPropertyName("oidc_expiration_date"), DateTimePredicate(Token = DateTimeToken.Hour)]
    ...
    /// </summary>
    [JsonPropertyName("oidc_payload"), StringPredicate]
    ...
    /// </summary>
    [JsonPropertyName("oidc_redemption_date"), DateTimePredicate(Token = DateTimeToken.Hour)]
    ...
    /// </summary>
    [JsonPropertyName("oidc_reference_id"), StringPredicate]
