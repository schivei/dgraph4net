...
public static class ClassMapping
{
    ...
    public static (ByteString, ByteString) ToJsonBs(object data, bool dropIfNull = false) =>
        data switch
        {
            IEntity entity => ImplClassMapping.ToJsonBs(entity, dropIfNull),
            IEnumerable<IEntity> entities => ImplClassMapping.ToJsonBs(entities, dropIfNull),
            _ => throw new InvalidConstraintException("The object must be an IEntity or IEnumerable<IEntity>.")
        };
    ...
    public static IServiceCollection AddDgraph(this IServiceCollection services, Func<IServiceProvider, string> getConnectionString, bool useNQuads = false)
    {
        ...
        ImplClassMapping ??= new ClassMappingImpl();
