    ...
    where TUserToken : class, IUserToken, new()
{
    ...
    [JsonPropertyName("claims"), ReversePredicate, PredicateReferencesTo(typeof(IUserClaim))]
    ...
    [JsonPropertyName("roles"), ReversePredicate, PredicateReferencesTo(typeof(IRole))]
    public virtual List<TRole> Roles { get; set; } = new List<TRole>();

    [JsonPropertyName("logins"), ReversePredicate, PredicateReferencesTo(typeof(IUserLogin))]
    public virtual List<TUserLogin> Logins { get; set; } = new List<TUserLogin>();
    
    [JsonPropertyName("tokens"), ReversePredicate, PredicateReferencesTo(typeof(IUserToken))]
    public virtual List<TUserToken> Tokens { get; set; } = new List<TUserToken>();
    
    [PersonalData]
    [JsonPropertyName("password_hash"), StringPredicate]
    public virtual string PasswordHash { get; set; }

    [JsonPropertyName("lockout_end"), DateTimePredicate(Token = DateTimeToken.Hour)]
    public virtual DateTimeOffset? LockoutEnd { get; set; }

    [PersonalData]
    [JsonPropertyName("two_factor_enabled"), CommonPredicate]
    public virtual bool TwoFactorEnabled { get; set; }

    [PersonalData]
    [JsonPropertyName("phonenumber_confirmed"), CommonPredicate]
    public virtual bool PhoneNumberConfirmed { get; set; }

    [ProtectedPersonalData]
    [JsonPropertyName("phonenumber"), StringPredicate]
    public virtual string PhoneNumber { get; set; }

    [JsonPropertyName("concurrency_stamp"), StringPredicate]
    public virtual string ConcurrencyStamp { get; set; }

    [JsonPropertyName("security_stamp"), StringPredicate]
    public virtual string SecurityStamp { get; set; }

    [PersonalData]
    [JsonPropertyName("email_confirmed"), CommonPredicate]
    public virtual bool EmailConfirmed { get; set; }

    [JsonPropertyName("normalized_email"), StringPredicate(Token = StringToken.Exact)]
    public virtual string NormalizedEmail { get; set; }

    [ProtectedPersonalData]
    [JsonPropertyName("email"), StringPredicate(Token = StringToken.Exact)]
    public virtual string Email { get; set; }

    [JsonPropertyName("normalized_username"), StringPredicate(Token = StringToken.Exact)]
    public virtual string NormalizedUserName { get; set; }

    [ProtectedPersonalData]
    [JsonPropertyName("username"), StringPredicate(Token = StringToken.Exact)]
    public virtual string UserName { get; set; }

    [JsonPropertyName("lockout_enabled"), CommonPredicate]
    public virtual bool LockoutEnabled { get; set; }

    [JsonPropertyName("access_failed_count"), CommonPredicate]
